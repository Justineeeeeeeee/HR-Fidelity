          ...
          <div class="col-12" >
            <div class="card">
              <div class="card-header">
                <h1 class="card-title">Leave Report</h1>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                $sql = "SELECT tbl_employees.employee_id, tbl_employees.employee_name,employee_Leave.Leave_Date,employee_leave.Leave_Status, tbl_employees.employee_username, tbl_employees.managed_id from employee_leave inner JOIN tbl_employees on tbl_employees.employee_name=employee_leave.Employee_Name WHERE tbl_employees.managed_id = '$employee_name'";
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="Employee_Paswword" id="Employee_Paswword" placeholder="Password">
                    </div>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label>Username</label>
                    <input type="text" class="form-control" name="Edit_Employee_Username"  id="Edit_Employee_Username" placeholder="Username">
                  </div>
                  <div class="form-group">
                    <label>Password</label>
                    <input type="text" class="form-control" name="Edit_Employee_Password" id="Edit_Employee_Password" placeholder="Password">
                  </div>
                </div>
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
document.getElementById("Edit_Employee_Name").value = $(this).closest("tr").children(":eq(1)").text();
document.getElementById("Edit_Employee_Username").value = $(this).closest("tr").children(":eq(2)").text();
document.getElementById("Edit_Employee_Password").value = $(this).closest("tr").children(":eq(3)").text();
