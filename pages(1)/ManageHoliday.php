        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="float-right">
                  <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal-add-new"><i class="fas fa-user-plus"></i> Add Holiday</button>
              </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="Holiday_Date"  id="Holiday_Date" placeholder="Holiday Date">
                    </div>
                    <div class="form-group">
                      <label>Holiday Type</label>
                      <input type="text" class="form-control" name="Holiday_Type"  id="Holiday_Type" placeholder="Holiday Type">
                    </div>
          ...
          <div class="modal fade edit" id="modal-edit-administrator">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Edit Holiday Information</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  ...
                  <div class="form-group">
                  <label>Holiday Name</label>
                    <input type="text" class="form-control" name="Edit_Holiday_Name" id="Edit_Holiday_Name" placeholder="Name">
                  </div>
                  <div class="form-group">
                  <label>Holiday Date</label>
                    <input type="date" class="form-control" name="Edit_Holiday_Date"  id="Edit_Holiday_Date" placeholder="Username">
                  </div>
                  <div class="form-group">
                  <label>Holiday Type</label>
                    <input type="text" class="form-control" name="Edit_Holiday_Type" id="Edit_Holiday_Type" placeholder="Password">
                  </div>
                </div>
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
$("#form_new").submit(function(event) {
  ...
  var Toast = Swal.mixin({
    ...
    $.ajax({
        type: "POST",
        cache: false,
        url: 'Process/Process_Manage_Holiday.php',
        data: form.serialize(),
...
document.getElementById("Edit_Holiday_ID").value = $(this).closest("tr").attr('id');
document.getElementById("Edit_Holiday_Name").value = $(this).closest("tr").children(":eq(1)").text();
document.getElementById("Edit_Holiday_Date").value = $(this).closest("tr").children(":eq(2)").text();
document.getElementById("Edit_Holiday_Type").value = $(this).closest("tr").children(":eq(3)").text();
...
var Edit_Holiday_ID = $(this).closest("tr").attr('id');
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({
          ...
          cache: false,
          url: 'Process/Process_Manage_Holiday.php',
          data: {type:'delete',Edit_Holiday_ID:Edit_Holiday_ID},
          success:function(data){
