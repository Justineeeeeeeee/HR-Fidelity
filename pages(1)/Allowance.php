        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="float-right">
                  <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal-add-new"><i class="fas fa-user-plus"></i> Add Allowance</button>
              </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th width = "5%">No.</th>
                    <th width = "10%">Allowance ID</th>
                    <th width = "20%">Allowance Name</th>
                    <th width = "15%">Amount</th>
                    <th width = "15%">Allowance Code</th>
                    <th width = "40%"></th>
                ...
                $result = mysqli_query($conn, $sql);
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) { ?>
                      <tr id = <?php echo $row["Allowance_ID"]; ?>>
                        <td><?php echo $i; ?></td>
                        <td  data-name = "<?php echo $row["Allowance_Name"] ?>" ><?php echo $row["Allowance_Name"]; ?></td>
                        <td data-Username = "<?php echo $row["Amount"] ?>" ><?php echo $row["Amount"]; ?></td>
                        <td data-Password = "<?php echo $row["Allowance_code"]  ?>"  ><?php echo $row["Allowance_code"]; ?></td>
                        <td>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title">New Allowance</h4>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="Allowance_Name" id="Allowance_Name" placeholder="Allowance Name">
                    </div>
                    <div class="form-group">
                      <label>Amount</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="Allowance_code" id="Allowance_code" placeholder="Allowance Code">
                    </div>
          ...
          <div class="modal fade edit" id="modal-edit-administrator">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Edit Allowance Information</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label>Allowance Name</label>
                    <input type="text" class="form-control" name="Edit_Allowance_Name" id="Edit_Allowance_Name" placeholder="Allowance name">
                  </div>
                  <div class="form-group">
                    <label>Amount</label>
                    <input type="text" class="form-control" name="Edit_Amount"  id="Edit_Amount" placeholder="Amount">
                  </div>
                  <div class="form-group">
                    <label>Allowance Code</label>
                    <input type="text" class="form-control" name="Edit_Allowance_code" id="Edit_Allowance_code" placeholder="Allowance Code">
                  </div>
                </div>
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
$("#form_new").submit(function(event) {
  ...
  var Toast = Swal.mixin({
    ...
    $.ajax({
        type: "POST",
        cache: false,
        url: 'Process/Process_Allowance.php',
        data: form.serialize(),
...
document.getElementById("Edit_Allowance_ID").value = $(this).closest("tr").attr('id');
document.getElementById("Edit_Allowance_Name").value = $(this).closest("tr").children(":eq(1)").text();
document.getElementById("Edit_Amount").value = $(this).closest("tr").children(":eq(2)").text();
document.getElementById("Edit_Allowance_code").value = $(this).closest("tr").children(":eq(3)").text();
...
var Edit_Allowance_ID = $(this).closest("tr").attr('id');
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({
          ...
          cache: false,
          url: 'Process/Process_Allowance.php',
          data: {type:'delete',Edit_Allowance_ID:Edit_Allowance_ID},
          success:function(data){
