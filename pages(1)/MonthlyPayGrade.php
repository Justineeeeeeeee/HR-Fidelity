          ...
          <div class="col-12" >
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Salary Grade Information</h3>
                <div class="float-right">
                  <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal-add-new"><i class="fas fa-user-plus"></i> Add Salary Grade</button>
              </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                $result = mysqli_query($conn, $sql);
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) { ?>
                      <tr id = <?php echo $row["Job_Title_ID"]; ?>>
                        <td><?php echo $i; ?></td>
                        <td  data-name = "<?php echo $row["Salary_Grade"] ?>" ><?php echo $row["Salary_Grade"]; ?></td>
                        <td data-Password = "<?php echo $row["Job_Title"]  ?>"  ><?php echo $row["Job_Title"]; ?></td>
                        <td data-Username = "<?php echo $row["salary_amount"] ?>" ><?php echo $row["salary_amount"]; ?></td>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="Salary_Grade" id="Salary_Grade" placeholder="Salary Grade">
                    </div>
                    <div class="form-group">
                      <label>Monthly Salary</label>
                      <input type="number" class="form-control" name="Montly_Salary"  id="Montly_Salary" placeholder="Monthly Salary">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="modal-footer justify-content-between">
                    ...
                    <input type="submit" class="btn btn-primary" id = "btnAddNewRecord" value = "Add New Salary Grade">
                  </div>
                </div>
                <!-- /.modal-content -->
              </div>
