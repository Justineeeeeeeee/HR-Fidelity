  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="../indexSuperadmin.php" class="d-block"><?php echo $_SESSION["superadmin_name"] ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../indexSuperadmin.php" class="nav-link in-active">
          ...
          <li class="nav-item">
            <a href="/pages(1)/Manage_HR.php" class="nav-link active">
        ...
        <div class="row">
          <div class="col-12" >
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Human Resource Manager Information</h3>
                <div class="float-right">
                  <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal-add-new"><i class="fas fa-user-plus"></i> Add HR</button>
              </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) { ?>
                      <tr id = <?php echo $row["HR_ID"]; ?>>
                        <td><?php echo $i; ?></td>
                        <td  data-name = "<?php echo $row["HR_Name"] ?>" ><?php echo $row["HR_Name"]; ?></td>
                        <td data-Username = "<?php echo $row["HR_Username"] ?>" ><?php echo $row["HR_Username"]; ?></td>
                        <td>
                          <?php
                            if($row["Status"])
                            {
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title">New Human Resource Manager</h4>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="username" class="form-control" name="HR_Username"  id="HR_Username" placeholder="Username">
                    </div>
                    <div class="form-group">
                      <label>Password</label>
                      <input type="Password" class="form-control" name="HR_Password" id="HR_Password" placeholder="Password">
                    </div>
                    <div class="form-group">
                      <label>Confirm Password</label>
                      <input type="password" class="form-control" name="HR_confirm_password" id="HR_confirm_password" placeholder="Confirm Password">
                    </div>
          ...
          <div class="modal fade edit" id="modal-edit-administrator">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Edit Human Resource Manager</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label>Password</label>
                    <input type="Password" class="form-control" name="edit_HR_Admin_Password" id="edit_HR_Admin_Password" placeholder="Password">
                  </div>
                  <div class="form-group">
                      <label>Confirm Password</label>
                      <input type="password" class="form-control" name="edit_HR_confirm_password" id="edit_HR_confirm_password" placeholder="Confirm Password">
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
$("#form_new").submit(function(event) {
  ...
  var Toast = Swal.mixin({
    ...
    $.ajax({
        type: "POST",
        cache: false,
        url: 'Process/Process_Manage_HR.php',
        data: form.serialize(),
...
document.getElementById("edit_HR_id").value = $(this).closest("tr").attr('id');
document.getElementById("edit_HR_Admin_Name").value = $(this).closest("tr").children(":eq(1)").text();
document.getElementById("edit_HR_Admin_Username").value = $(this).closest("tr").children(":eq(2)").text();
...
var edit_HR_id = $(this).closest("tr").attr('id');
...
{$.ajax({
      ...
      cache: false,
      url: 'Process/Process_Manage_HR.php',
      data: {type:'activate',edit_HR_id:edit_HR_id},
      success:function(data){
        var response_data = JSON.parse(data);
...
$.ajax({
    ...
    cache: false,
    url: 'Process/Process_Manage_HR.php',
    data: {type:'deactivate',edit_HR_id:edit_HR_id},
    success:function(data){
      var response_data = JSON.parse(data);
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({
          ...
          cache: false,
          url: 'Process/Process_Manage_HR.php',
          data: {type:'delete',edit_HR_id:edit_HR_id},
          success:function(data){
